...
class Solution(Scene):
    def construct(self):
        ...
        eq1_1 = MathTex(r"M(x, y) = x + y, \, N(x, y) = x").move_to(ORIGIN)
        eq1_2 = MathTex(r"\frac{\partial M}{\partial y} = \frac{\partial}{\partial y}(x + y) = 1").move_to(ORIGIN)
        eq1_3 = MathTex(r"\frac{\partial N}{\partial x} = \frac{\partial}{\partial x}(x) = 1").move_to(ORIGIN)
        eq1_4 = MathTex(r"\frac{\partial M}{\partial y} = \frac{\partial N}{\partial x}").move_to(ORIGIN)
        eq1_5 = MathTex(r"\text{The differential is exact}").move_to(ORIGIN)
        eq1_6 = MathTex(r"F(x, y) = \int (x + y) \, dx = \frac{x^2}{2} + xy + g(y)").move_to(ORIGIN)
        eq1_7 = MathTex(r"\frac{\partial F}{\partial y} = x + g'(y) = x").move_to(ORIGIN)
        eq1_8 = MathTex(r"g'(y) = 0 \implies g(y) = C").move_to(ORIGIN)
        eq1_9 = MathTex(r"F(x, y) = \frac{x^2}{2} + xy + C").move_to(ORIGIN)
        eq1_10 = MathTex(r"F(x, y) = C \implies \frac{x^2}{2} + xy = C").move_to(ORIGIN)
        ...
        self.wait(2)
        self.play(FadeOut(description1, eq1_10))
        ...
        eq2_2 = MathTex(r"\mu(x) = e^{\int 1 \, dx} = e^x").move_to(ORIGIN)
        eq2_3 = MathTex(r"e^x \frac{dy}{dx} + e^x y = -xe^x").move_to(ORIGIN)
        ...
        self.wait(2)
        self.play(FadeOut(description2, eq2_8))
